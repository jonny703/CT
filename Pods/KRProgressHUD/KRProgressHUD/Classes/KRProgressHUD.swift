...
//      case .black: return UIColor(red: 0.333, green: 0.443, blue: 0.6, alpha: 0.6)
      }
   }
}
...
public enum KRProgressHUDStyle {
   ...
   var backgroundColor: UIColor {
      switch self {
      case .white: return UIColor(red: 0.188, green: 0.271, blue: 0.361, alpha: 1.0)
      case .black: return UIColor(red: 0.188, green: 0.271, blue: 0.361, alpha: 1.0)
